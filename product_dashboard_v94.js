// SLS Breakage Monitoring v94 — dashboard dimensions: Size, Pabrikasi, Kiriman, Jenis.
(function(){
  'use strict';
  ...
  function ensureSection(){
    if($('productDimV94'))return;const page=$('page-ringkasan');if(!page)return;
    ...
    const box=document.createElement('div');box.id='productDimV94';box.innerHTML='<div class="section-title" style="margin-top:14px">Profil Breakage Produk <span class="right small muted">Qty BOX · mengikuti Periode & RDC</span></div><div class="pd-grid"><div class="card pd-card"><div class="pd-kicker">DIMENSI 1</div><div class="pd-title">Size</div><div class="pd-sub">Distribusi breakage berdasarkan size produk</div><div id="pdSize"></div></div><div class="card pd-card"><div class="pd-kicker">DIMENSI 2</div><div class="pd-title">Pabrikasi</div><div class="pd-sub">Pabrik asal SRKI / RCI</div><div id="pdFactory"></div></div><div class="card pd-card"><div class="pd-kicker">DIMENSI 3</div><div class="pd-title">Kiriman</div><div class="pd-sub">Perbandingan breakage Kiriman vs Gudang</div><div id="pdShipment"></div></div><div class="card pd-card"><div class="pd-kicker">DIMENSI 4</div><div class="pd-title">Jenis</div><div class="pd-sub">Granit vs Keramik</div><div id="pdKind"></div></div></div>';
  ...
  function renderDims(){
    ...
    $('pdKind').innerHTML=bars(group('product_kind'),4);
  }
